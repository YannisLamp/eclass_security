...
class action {
    ...
    function record($module_name, $action_name = "access") {
        ...
        $sql = "SELECT id, TIME_TO_SEC(TIMEDIFF(NOW(), date_time)) AS diff, action_type_id
                FROM actions
                WHERE user_id = ".mysql_real_escape_string($uid)." ORDER BY id DESC LIMIT 1";
        ...
        $sql = "INSERT INTO actions SET
                    ...
                    action_type_id = ".mysql_real_escape_string($action_type_id).",
                    date_time = NOW(),
        ...
        while ($end_date < $current_month){
            ...
            while ($row = mysql_fetch_assoc($result)) {
                ...
                $sql_2 = "SELECT count(id) as visits, sum(duration) as total_dur FROM actions ".
                    " WHERE module_id = ".mysql_real_escape_string($module_id)." AND ".
                    " date_time >= '".mysql_real_escape_string($start_date)."' AND ".
                    " date_time < '".mysql_real_escape_string($end_date)."' ";
                ...
                $sql_3 = "INSERT INTO actions_summary SET ".
                    " module_id = ".mysql_real_escape_string($module_id).", ".
                    " visits = ".mysql_real_escape_string($visits).", ".
                    " start_date = '".mysql_real_escape_string($start_date)."', ".
                    " end_date = '".mysql_real_escape_string($end_date)."', ".
                    " duration = ".mysql_real_escape_string($total_dur);
                $result_3 = db_query($sql_3, $currentCourseID);
                @mysql_free_result($result_3);
            
                $sql_4 = "DELETE FROM actions ".
                    " WHERE module_id = ".mysql_real_escape_string($module_id).
                    " AND date_time >= '".mysql_real_escape_string($start_date)."' AND ".
                    " date_time < '".mysql_real_escape_string($end_date)."'";

...
if (isset($result))  {
	...
	while ($fac = mysql_fetch_array($result)) {
		...
		$n=mysql_query("SELECT COUNT(*) FROM cours_faculte WHERE facid=".mysql_real_escape_string($fac[id])."");
		$r=mysql_fetch_array($n);
		$tool_content .= "<font style='color: #CAC3B5;'>&nbsp;&nbsp;-&nbsp;&nbsp;$langThereAre ".htmlspecialchars($r[0])."&nbsp;".  htmlspecialchars(($r[0] == 1? $langAvCours: $langAvCourses)) . "</small></td>
		</tr>";
		$k++;
	}

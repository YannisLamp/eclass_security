...
for ($j = 0; $j < mysql_num_rows($sql); $j++) {
	...
	<td><a href='{$urlServer}courses/$logs[code]/'><b>".htmlspecialchars(stripslashes($logs[2]))."</b>
	</a> (".htmlspecialchars(stripslashes($logs[1])).")<br /><i>".$logs[3]."</i>
	</td>
	<td align='center'>";
	// Define course type
	switch ($logs[4]) {
	...
	$tool_content .= "</td><td>".htmlspecialchars(stripslashes($logs[0]))."</td>";

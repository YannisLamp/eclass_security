...
$result = mysql_query($sql);
$myrow = mysql_fetch_array($result);
$last_prof_info = "<b>".htmlspecialchars($myrow['prenom']." ".$myrow['nom'])."</b> (".htmlspecialchars($myrow['email'].", ".date("j/n/Y H:i",$myrow['registered_at'])).")";
...
$result = mysql_query($sql);
$myrow = mysql_fetch_array($result);
$last_stud_info = "<b>".htmlspecialchars($myrow['prenom']." ".$myrow['nom'])."</b> (".htmlspecialchars($myrow['email'].", ".date("j/n/Y H:i",$myrow['registered_at'])).")";
